    ...
    private void run() throws IOException, InterruptedException {
        ...
        try {
            ...
            while ( true ) { // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                // ***** MOVING *****
                MoveTargetLocation moveTargetLocation = chooseMoveTargetLocation(
                    scanMapTiles, currentLocInMapTile, currentLoc,
                    mapTileCenter );
                ...
                if ( !previousLoc.equals( getCurrentLocation() ) ) {
                    coordVisitCountMap.put( moveTargetLocation.targetCoord,
                        coordVisitCountMap.get( moveTargetLocation.targetCoord )
                            + 1 );
                }

                try {
                    communication.sendTweet( getCurrentLocation().xpos,
                        getCurrentLocation().ypos );
