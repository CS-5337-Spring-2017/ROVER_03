...
public class jsonConvertionTests {
	...
	public static void main(String[] args) throws ParseException {
		...
		MapTile mtile1 = new MapTile(Terrain.ROCK, Science.CRYSTAL, 1, true, "00");
		...
		String jsonScanMap = gson.toJson(sMap); // money shot - object to json
												// string
		...
		sMap2 = gson.fromJson(jsonScanMap, ScanMap.class); // money shot two -
															// json string to
															// object
